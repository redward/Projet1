...
class JUnaryPlusOp extends JUnaryExpression {
    ...
    /**
     * Construct an AST node for an unary plus expr given its line number, and the
     * operand.
     * 
     * @param line
     *            line in which the expression occurs in the source file.
    ...
    /**
     * Analyze the operand as an arg, check types
     * and determine the type of the result.
     * 
     * @param context
     *            context in which names are resolved.
     ...
     * the operand, and then the unary plus instruction.
     * 
     * @param output
     *            the code emitter (basically an abstraction for producing the
     *            .class file).
